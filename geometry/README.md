...
Alternatively if new geometry is to be implemented one can specify `./make_mesh.sh gui` to start salome grapical and run the script (`build_geometry.py`) with Ctrl+t inside.  
