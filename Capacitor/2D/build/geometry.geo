...
plate_length    = 0.5;     // X-length of each plate
plate_gap       = 0.1;        // distance between facing plate surfaces (Y)
plate_thickness = 0.1;  // plate height in 2D (Y extent)
padding_length  = 1;   // extra space left/right
padding_gap     = 1;      // extra space above/below
thickness_z     = 0.05;      // total extent in Z
